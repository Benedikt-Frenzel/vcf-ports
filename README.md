...
- Self-contained SVG export of the currently selected component paths, including active filters, mapped environment labels, visual selection state, and the complete port list grouped by direction.
